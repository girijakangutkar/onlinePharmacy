...
//             className="w-90 h-40 rounded-lg"
//           />
...
//       <div className="w-[85%] overflow-x-auto hide-scrollbar">
//         <h1 className="align-left font-bold text-2xl">
//           Lab Tests by Health Concern
//         </h1>
//         <div className="absolute left-20 top-108">
//           <FaChevronCircleLeft size={40} onClick={() => scrollMed("left")} />
//         </div>
//         <div className="flex flex-row gap-4 w-max p-10" ref={scrollRef}>
...
//           </div>
//         </div>
//         <div className="absolute right-20 top-108">
//           <FaChevronCircleRight size={40} onClick={() => scrollMed("right")} />
//         </div>
//       </div>
//     </div>
//   );
