...
const Diabetes = () => {
  const { PriceFilter, fetchMedicines, isLoading } = useContext(FetchIt);
  ...
  useEffect(() => {
    fetchMedicines(
      "https://api.prod.instamed.in/api/v1/get-master-menu-items-by-menu-id-web/83?perPage=50&page=5&language=en"
    );
  }, []);
  ...
  return (
    <div className="flex flex-col justify-center items-center sm:flex-col md:flex-col xl:flex-row 2xl:flex-row justify-center p-4 w-full mt-[3%]">
      ...
      <div className="w-full sm:w-full md:w-[90%] xl:w-w-4/5 2xl:w-w-4/5 overflow-auto max-h-[80vh] hide-scrollbar 2xl:mt-10">
        <h1 className="font-bold text-2xl m-5 mt-0">DIABETES</h1>
